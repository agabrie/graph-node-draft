 ...
 * mutation service's staged commit, checks come from the validation service.
...
Graph.prototype.metaOf = function (kind, id) { return T.metaOf(this.doc, kind, id); };
Graph.prototype.typeOf = function (id) { return T.typeOf(this.doc, id); };
...
Graph.prototype.visibleAncestorOf = function (id) { return T.visibleAncestorOf(this.doc, id); };
Graph.prototype.depthOf = function (id) { return T.depthOf(this.doc, id); };
Graph.prototype.isChildrenLocked = function (id) { return T.isChildrenLocked(this.doc, id); };
Graph.prototype.isLinkLocked = function (id) { return T.isLinkLocked(this.doc, id); };
Graph.prototype.ancestorsOf = function (id) { return T.ancestorsOf(this.doc, id); };
Graph.prototype.linkLockedCompanions = function (id) { return T.linkLockedCompanions(this.doc, id); };
